...
function reme_links_admin() {
    ...
    update_option('reme_vk', $vk);
		...
		update_option('reme_website', $website);
		...
		<form name="contactForm" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
			...
			<table class="form-table">
				<tbody>
					...
					<tr>
						<th><label for="website"><i class="fa fa-desktop" aria-hidden="true"></i> | <?php _e('Website', 'reach-me'); ?></label></th>
						<td><input id="website" name="website" class="regular-text" type="text" value="<?php echo get_option('reme_website'); ?>"></td>
					</tr>
				</tbody>
			</table>
